...
import {DEFAULT_THEME_COLOR} from '../config/config.js';
...
const defaultTheme: ThemeStyles = {
  ...
  elements: {
    h1: {
      display: 'table',
      padding: '0 1em',
      borderBottom: '2px solid ' + DEFAULT_THEME_COLOR,
      margin: '2em auto 1em',
      fontSize: '1.3em',
      fontWeight: 'bold',
      textAlign: 'center',
    ...
    h3: {
      paddingLeft: '8px',
      borderLeft: '3px solid ' + DEFAULT_THEME_COLOR,
    ...
    blockquote: {
      fontStyle: 'normal',
      padding: '1em',
      borderLeft: '4px solid ' + DEFAULT_THEME_COLOR,
      borderRadius: '6px',
...
const graceTheme: ThemeStyles = toMerged(defaultTheme, {
  ...
  elements: {
    ...
    h3: {
      ...
      fontSize: '1.2em',
      borderLeft: '4px solid ' + DEFAULT_THEME_COLOR,
      borderBottom: '1px dashed ' + DEFAULT_THEME_COLOR,
    },
    h4: {
      fontSize: '1.1em',
    },
